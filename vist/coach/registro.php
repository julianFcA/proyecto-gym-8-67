                ...
                <form method="POST" name="formreg"  id="signup-form" class="signup-form" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                <input type="number" name="dad" class="material-control tooltips-general" placeholder="Ingresar edad">
                                <label>Edad</label>
                            </div>
                            <div class="group-material">
                                <input type="float" name="estat" class="material-control tooltips-general" placeholder="Ingresar estatura">
                                <label>Estatura</label>
                            </div>
                            <div class="group-material">
                                <input type="date" name="fecha_na" class="material-control tooltips-general">
