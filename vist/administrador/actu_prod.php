...
<?php
    ...
    if((isset($_POST["MM_insert"]))&&($_POST["MM_insert"]=="formreg"))
    {
        ...
        if ( $id_producto==""|| $producto=="" ||$precio=="" || $descripcion=="" || $cantidad==""){
            ...
            echo '<script> windows.location= "actu_prod.php"</script>';
              ...
              <h1 class="all-tittles">Actualizar Producto</small></h1>
                    ...
                    <form method="post" name="formreg" autocomplete="off">
                        ...
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            ...
                            <div class="group-material">
                                <input type="text" name="descripcion" class="material-control tooltips-general" pattern="[a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z] {1,2,3,4,5,6,7,8,9,0}" placeholder="Ingresar estatura">
