                        ...
                        <div class="row">
                            <div class="col-md-7 pe-0">
                                <div class="form-left h-100 py-5 px-5">
                                    <form method="POST" name="form1" id="form1" autocomplete="off" action="enviarcorreo.php" autocomplete="off" class="row g-4">
                                    <h3 class="mb-3">VALIDACION DE CORREO</h3>
                                        <div class="col-12">
                                            <label>CORREO<span class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="bi bi-person-fill"></i></div>
                                                <input type="email" name="correo" minlength="6" maxlength="50" id="doc" class="form-control" placeholder="Digite Su Correo" oninput="maxlengthNumber(this);">
                                            </div>
                                        </div>
